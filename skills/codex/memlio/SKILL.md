...
- File capture needs an accessible absolute path inside a folder allowed with `memlio setup codex --allow-path <folder>` or a client filesystem root.
